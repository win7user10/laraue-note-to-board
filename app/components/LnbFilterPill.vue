<script setup lang="ts">
  ...
  const openPopupRef = ref<HTMLDivElement>();
</script>
...
<template>
  <div class="filter">
    ...
    <div class="filter-wrap" ref="openPopupRef">
      <!-- Pill -->
      ...
      <LnbPopup v-if="epicFilterOpen" :min-width="200" @close="epicFilterOpen = false" :parentRef="openPopupRef">
